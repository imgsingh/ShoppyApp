        ...
        drawer.setOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
            ...
            public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                if (drawerItem.getIdentifier() == 0) {
                    Intent intent = new Intent(FaqPage.this, MainAppPage.class);
                    startActivity(intent);
                    drawer.closeDrawer();
                } else if (drawerItem.getIdentifier() == 1) {
                    Intent intent = new Intent(FaqPage.this, AboutUs.class);
                    startActivity(intent);
                    ...
                    Intent intent = new Intent(FaqPage.this, Feedback.class);
                    startActivity(intent);
                    drawer.closeDrawer();
                }else if (drawerItem.getIdentifier() == 6) {
                    Intent intent = new Intent(FaqPage.this, CheckOutScreen.class);
                    startActivity(intent);
                    drawer.closeDrawer();
                }
                return true;
